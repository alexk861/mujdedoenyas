      ...
      <div style="font-family: 'Georgia', serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 15px;">
          ...
          <tr style="border-bottom: 1px solid #eee;">
            ...
            <td style="padding: 12px 0;">
              <a href="mailto:${escapeHtml(email)}" style="color: #8B7355;">${escapeHtml(email)}</a>
            </td>
          </tr>
          <tr style="border-bottom: 1px solid #eee;">
            <td style="padding: 12px 0; font-weight: bold; vertical-align: top; color: #555;">Piece</td>
            <td style="padding: 12px 0; font-style: italic;">${escapeHtml(piece)}</td>
          </tr>
          ${story ? `
          <tr>
            <td style="padding: 12px 0; font-weight: bold; vertical-align: top; color: #555;">Story</td>
            <td style="padding: 12px 0;">${escapeHtml(story).replace(/\n/g, '<br>')}</td>
          </tr>
          ` : ''}
        </table>
        ...
        <div style="margin-top: 32px; padding-top: 16px; border-top: 1px solid #eee;">
          <p style="font-size: 12px; color: #999; margin: 0;">
            This request was submitted via the Müjde Doenyas website contact form.
          </p>
        </div>
      </div>
    `;
